...
The shared `tait/` package supports the diagrammatic constructions in Sections 2–4 of *Computation of Unknotting Numbers: Which Knot Breaks the Bernhard–Jablan Conjecture?*. A diagram is represented by a signed plane multigraph with a rotation system. Changing one crossing reverses one edge sign; isotopies must preserve the embedded graph's diagrammatic information.
