...
if __name__ == '__main__':
    names = sys.argv[1:] or ['13n_30', '13n_45', '13n_80', '13n_2379', '13n_2809', '13n_2907', '13n_3033', '13n_3589']
    for nm in names:
        d = json.load(open(os.path.join(os.path.dirname(os.path.abspath(__file__)),
                                        '..', 'results', 'best', f'{nm}.json')))
        b = d['best']
        draw(b['pd_knot'], b['change_rows_0based'], f'figures/fig_{nm}.pdf',
             title=nm.replace('_', ''))
        print('drawn', nm, len(b['pd_knot']), 'crossings, marked', b['change_rows_0based'])
