...
These programs implement Section 3.7, **Montesinos knots**, of *Computation of Unknotting Numbers: Which Knot Breaks the Bernhard–Jablan Conjecture?*, manuscript v1.8. The frozen `v1.3` computational profile retains the 50 targets and deposited results used in this calculation.
